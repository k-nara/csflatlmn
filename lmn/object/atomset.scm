...
;; て不適切であるため、このような <atomset> は ill-formed であると言う
;; ことにする。また <atomset> が含むアトムに ill-formed なものが含まれ
;; る場合もこれを ill-formed であると言うことにする。
;;
;; 対して、 ill-formed でないグラフは LMNtal (グラフの部分) グラフとし
;; て適切なものになるから、部分プロセスと呼んで区別する。また、自由リン
;; クを持たない部分プロセスを特にプロセスと呼ぶ。
